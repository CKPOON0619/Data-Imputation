...
class myCritic(Module):
    ...
    def train(self,data_batch,adjusted_generated_data,fixed_mask,mask,hints,alpha,missRate,optimizer):
        '''
    ...
    def criticise(self,adjusted_generated_x,hints):
        """
